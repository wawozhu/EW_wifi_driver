...
static struct usb_device_id rtw_usb_id_tbl[] = {
	...
	{USB_DEVICE_AND_INTERFACE_INFO(USB_VENDER_ID_EDIMAX, 0xb822, 0xff, 0xff, 0xff), .driver_info = RTL8822B}, /* Edimax - Edimax*/
	{USB_DEVICE_AND_INTERFACE_INFO(USB_VENDER_ID_EDIMAX, 0xc822, 0xff, 0xff, 0xff), .driver_info = RTL8822B}, /* Edimax - Edimax*/
	{USB_DEVICE_AND_INTERFACE_INFO(USB_VENDER_ID_EDIMAX, 0xf822, 0xff, 0xff, 0xff), .driver_info = RTL8822B}, /* Edimax - Edimax*/
